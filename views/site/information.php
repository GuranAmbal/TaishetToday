...
$this->registerMetaTag(['name' => 'keywords', 'content' => 'Тайшетский сайт, городской портал тайшета, события в тайшете, что делать в тайшете, куда пойти в тайшете, афиша тайшета, театры в тайшете, цирк в тайшете, интересное в тайшете, лучшие места тайшета, знаменитые места в тайшете, куда пойти в тайшете, интересное в тайшете']);
...
<div class="header_happends">
	<p>Интересные события в Тайшете</p>
