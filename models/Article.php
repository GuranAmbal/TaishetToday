...
class Article extends \yii\db\ActiveRecord
{
  ...
  */
  ...
  {
    return Article::find()->orderBy('viewed desc')->where(['category_id'=>[6,11,12,13,14,20]])->limit(7)->all();
  }
  public static function getAllHistoryCategorys()
  {
    return Article::find()->orderBy('viewed desc')->where(['category_id'=>[6,11,12,13,14,20]])->limit(12)->all();
  }
  public static function getPopularHistory()
  {
    return Article::find()->orderBy('viewed desc')->where(['category_id'=>[6,11,12,13,14,20]])->limit(4)->all();
  }
