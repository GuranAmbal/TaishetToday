/*var multiItemSlider = (function () {
    ...
    return function (selector, config) {
      console.log(document.querySelector(selector).querySelectorAll('.slider__item'));
      var
...
slider.forEach((el)=>{
	var mySwiper = new Swiper(el, {
			...
			slideNextClass:"slider__control_right",
			slidePrevClass:"slider__control_left",
			loop: true,
			autoplay: {
					delay: 2000
			},
 ...
 window.addEventListener('resize', function () {
     ...
     var  width = parseFloat(document.body.clientWidth);
     var mainContainer=document.querySelector(".slider");
     if (width < 590) {

         mainContainer.classList.remove("swiper-no-swiping");
         mySwiper.update();
         //var sliderSwap = swipeSlider('.swipe');
     } else {
         mainContainer.classList.add("swiper-no-swiping");
         mySwiper.update();
     }
